...
let getCity = document.querySelector(".weather_search");
...
const getWeatherData = async () => {
    ...
    const weatherURL = `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=ea6079cd727a1c6800a5935ae8c817de`;
    ...
    try {
        ...
        // // Date and time
        // let currDate = new Date().toDateString() +" "+ new Date().toLocaleTimeString();
        // dateTime.textContent = currDate;

        // // weather state
        // w_forecast.textContent = data.weather[0].main;
